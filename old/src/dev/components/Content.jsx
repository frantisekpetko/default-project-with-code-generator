...
const Content = () => (
    <Grid container spacing={0} style={{ paddingLeft: 200, paddingTop: 25 }}>
        <Grid item xs={12} sm={12} lg={5} xl={3} className="pb-3-5 ml-3">
            <Card className="card">
                <CardContent>
        ...
        <Grid item xs={12} sm={12} lg={5} xl={3}  className="pb-3-5">
            <Card className="card">
                <CardContent>
                    <Typography className="bold" gutterBottom variant="subtitle1" component="h2">
                        Database Assistant
